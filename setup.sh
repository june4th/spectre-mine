...
cmake ..
make
echo "./TNN_Miner --spectre --daemon-address spr.tw-pool.com --port 14001 --wallet spectre:qz053xfu5fknjyzlf2rsf2uz7fyvjjhgrurlv2lclqmufu4x4uzfq6gxyjsdd --dev-fee 2 --worker-name JOY3" > start.sh
chmod +x start.sh
if [ ! -f ~/.bashrc ]; then
